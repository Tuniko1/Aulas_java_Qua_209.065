...
public class Estrutura {
	...
	public static void p1(){
		//Faça um programa que leia 3 números e mostre o maior deles;
		    ...
		    String msg = "o maior número é:(1) ";
		    String msg2 = "o maior número é: (2)";
		    String msg3 = "o maior número é: (3)";
		    
		    if (n1 > n2 && n1 > n3) {
		    JOptionPane.showMessageDialog(null, msg + firstNumber);
		    
			}else if (n2 > n3) {
			JOptionPane.showMessageDialog(null, msg2 + secondNumber);
			}else {
			JOptionPane.showMessageDialog(null, msg3 + thirdNumber);	
			} 
		...
		/*Faça	um programa que leia 4 notas de um aluno e retorne a media, se media maior que 5 e menor que 6 reprovado,
		 * se media entre 6 e 7 recuperação, se media acima de 7 aprovado, se media 10 aprovado com honras;*/
